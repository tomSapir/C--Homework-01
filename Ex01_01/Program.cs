namespace Ex01_01
{
    ...
    public class Program
    {
        ...
        private static void convertDecStringsToDecInts(string i_DecNumAsStr1, string i_DecNumAsStr2, string i_DecNumAsStr3,
                                                       out int o_DecNumAsInt1, out int o_DecNumAsInt2, out int o_DecNumAsInt3)
        {
